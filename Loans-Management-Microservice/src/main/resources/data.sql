...
insert into loanapplication(application_id , customer_id, loan_amount, tenure, collateral_details , status)values(10001,100005,40000,10,'House','applied');
insert into loanapplication(application_id , customer_id, loan_amount, tenure, collateral_details, status)values(10002,100003,50000,10,'Land','accepted');
insert into loanapplication(application_id , customer_id, loan_amount, tenure, collateral_details, status)values(10003,100002,60000,12,'Cash','rejected');
